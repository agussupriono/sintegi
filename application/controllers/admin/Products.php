...
//                $this->load->view('admin/layout/wrapper', $data);
                ...
                $data = array('slug_product' => $slugProduct,
                    ...
                    'image' => '',
                    'product_price_detail' => $i->post('product_price_detail'),
                    'product_price_detail2' => $i->post('product_price_detail2'),
                    'url_link' => $i->post('url_link'),
                    'flag_home' => ($i->post('flag_home')=="") ? 0 : $i->post('flag_home'),
