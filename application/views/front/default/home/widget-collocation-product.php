<?php
$secCollo = $this->mProducts->listProductsPubPosition('collocation');
    ...
    <div class="flex flex-wrap">
        ...
        <div class="col-12 sm-col-12 md-col-4 lg-col-4">
            <div class="pricelist center" <?php echo $strStyle; ?>>
                <?php echo $ribbon2; ?>
                <div class="pricing-title"><?php echo $colo['product_name']; ?></div>
                <div class="pricing-des"><?php echo $colo['product_price_detail']; ?></div>
                <div class="price" style="margin: 20px 0 20px;">
                    <span class="rp" style="position: relative; left: -90px;top: 30px;">IDR</span>
                    <div class="harga month" >
                        <p <?php echo $strStyle2; ?>><?php echo $colo['product_price_detail2']; ?></p>
                    </div>
                    <p>/ bulan</p>
                </div>
                <div class="pricing-spec" <?php echo $strStyle2; ?>><?php echo $colo['product_description']; ?></div>
