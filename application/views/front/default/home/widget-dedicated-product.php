<?php
$secProd = $this->mProducts->listProductsPubPosition('dedicated');
    ...
    <div class="flex flex-wrap">
        <?php foreach ($secProd as $pod) { 
            if($pod['flag_home']==0){
                ...
                $strStyle2 = ' style="background: #fff; color: black; min-width: 192px;" ';
                $ribbon2 = '';
            } else {
                ...
                $strStyle2 = ' style="background: none; min-width: 192px;" ';
