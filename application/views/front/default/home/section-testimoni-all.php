    ...
    <div class="container align-center" style="max-height: 500px; overflow-y: scroll; overflow-x: hidden; padding: 0px 10px;">
        <div class="mbr-row mbr-justify-content-center">
            ...
            <div class="card mbr-col-sm-12 mbr-col-md-6 mbr-col-lg-4">
                ...
                <div>
                    <div class="author-name mbr-fonts-style align-left mbr-bold display-4 align-center"><?php echo $secTesti["title"]; ?></div>
                    <div class="author-title mbr-fonts-style align-left display-4 align-center"><?php echo $secTesti["content_short"]; ?></div>
                </div>
