...
$total_rows = $this->mBlogs->totalSectionTestimoni();
$total_pages = ceil($total_rows / $no_of_records_per_page);

$secTestimoniHome = $this->mBlogs->listSectionTestimoni($no_of_records_per_page,$offset);

$display_paging = false;
?>
<section class="testimonials-slider3 cid-qEez0eJngM" id="testimonials1-1a">
    <div class="container align-center" style="max-height: 500px; overflow-y: scroll; overflow-x: hidden; padding: 0px 10px;">
        <div class="mbr-row mbr-justify-content-center">
            ...
            <div class="card mbr-col-sm-12 mbr-col-md-6 mbr-col-lg-4">
                ...
                <div class="signature">
                    <amp-img src="<?php echo base_url('assets/upload/image/').$secTesti["image"];?>" height="100"
                            style="height: 100px !important; width: 160px !important; display:block;" >
                    </amp-img>
                    <div>
                        <div class="author-name mbr-fonts-style align-left mbr-bold display-4"><?php echo $secTesti["title"]; ?></div>
                        <div class="author-title mbr-fonts-style align-left display-4"><?php echo $secTesti["content_short"]; ?></div>
                    </div>
                </div>
            </div>
            <?php } ?>
            <?php if($display_paging){ ?>
            <div class="mbr-col-md-12 align-center" style="color: #000; display: inline-block;">
                <div>
                    <div class="dataTables_paginate paging_simple_numbers">
                        <ul class="pagination">
                            <li class="paginate_button previous" aria-controls="dataTables-example" tabindex="0">
                                <a href="?pageno=1">Previous</a>
                            </li>
