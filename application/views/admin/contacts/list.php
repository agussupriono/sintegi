...
<tbody>
    ...
    <tr class="odd gradeX">
        ...
        <td><?php echo substr(strip_tags($list['email']),0,20) ?></td>        
        ...
        <td class="center">
        <a href="<?php echo base_url('admin/contacts/delete/'.$list['message_id']);?>" class="btn btn-danger" onClick="return confirm('Are you sure?')"><i class="fa fa-trash"></i> Delete</a>
