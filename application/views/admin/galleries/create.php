    ...
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <select name="position" class="form-control">
                ...
                <option value="background">Home - Background</option>                
                <option value="profil">Profil Page</option>                
                <option value="harga">Daftar Harga</option>                
                <option value="footer">Footer - Grid Image</option>                  
                <option value="teamcert">Team - Sertifikasi</option>                                  
                <option value="aboutus-partner">About Us - Partner</option>                                              
                <option value="aboutus-memberof">About Us - Members Of</option>                                              
                <option value="aboutus-sertifikasi">About Us - Sertifikasi</option>                                             
                <option value="dedicated-kolaboarsi">Dedicated - Kolaborasi</option>                             
                <option value="tool-security-network">Tool Security Network</option>  
                <option value="colocation-kolaboarsi">Collocation - Kolaborasi</option>  
                <option value="hosting-our-technology">Hosting - Our Technology</option>  
            </select>
        </div> 
        <div class="form-group">
            <label>Description</label>
            <textarea name="gallery_description" id="gallery_description" placeholder="Gallery Description" class="form-control"><?php echo set_value('gallery_description') ?></textarea>
        </div>
    </div><br>
    <div class="col-md-12">
