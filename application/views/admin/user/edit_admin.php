...
<form action="<?php echo base_url('admin/users/edit_admin/'.$admin['admin_id']) ?>" method="post">
 
  <div class="form-group input-group">
    <span class="input-group-addon">@</span>
    <input type="email" name="email" class="form-control" placeholder="Alamat email" required value="<?php echo $admin['email'] ?>">
  </div>
  <div class="form-group input-group">
