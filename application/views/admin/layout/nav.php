...
<ul class="nav" id="main-menu">
    ...
    <li><a href="#"><i class="fa fa-building-o"></i> Partner<span class="fa arrow"></span></a>
        <ul class="nav nav-second-level">
            <li><a href="<?php echo base_url('admin/partners') ?>">List Partner</a></li>
            <li><a href="<?php echo base_url('admin/partners/create') ?>">Create Partner</a></li>
        </ul>
    </li>  
